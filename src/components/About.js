    ...
    return (
        <div id='about'>
            <div id='aboutme' >
                ...
                <span data-aos="fade-right" data-aos-delay="100">I regularly create websites and web applications for my own portfolio, keep sharpening the saw, always thirst for more knowledge and look be up to date with technology .</span>
