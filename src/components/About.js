    ...
    return (
        <div id='about'>
            <div id='aboutme' >
                ...
                <span data-aos="fade-right" data-aos-delay="100">I regularly create websites and web applications for my own portfolio, keep sharpening the saw, always thirsty for more knowledge and look for being up to date with technology .</span>
